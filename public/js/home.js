    ...
    $(".js-store-apply").click(function (event) {
      ...
      $.ajax({
        ...
        success: function success(data) {
          ...
          $.modal.close();
          $("#apply-form")[0].reset();
          toastr__WEBPACK_IMPORTED_MODULE_0__.success(data.messages);
        },
        error: function error(response) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _components_inc_favourite__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../components/_inc_favourite */ "./resources/js/components/_inc_favourite.js");
/* harmony import */ var _components_inc_auth__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../components/_inc_auth */ "./resources/js/components/_inc_auth.js");
...
$(function () {
  Home.init();
  _components_inc_auth__WEBPACK_IMPORTED_MODULE_1__["default"].init();
  _components_inc_favourite__WEBPACK_IMPORTED_MODULE_0__["default"].init();
