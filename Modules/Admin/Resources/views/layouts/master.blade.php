...
<body class="h-100">
        ...
        <div class="row">
                        ...
                        <a class="navbar-brand w-100 mr-0" href="#" style="line-height: 25px;">
                            <div class="d-table m-auto">
                                <img id="main-logo" class="d-inline-block align-top mr-1" style="max-width: 25px;"
                                    src="{{ asset('../template_admin/images/shards-dashboards-logo.svg') }}">
            ...
            <main class="main-content col-lg-10 col-md-9 col-sm-12 p-0 offset-lg-2 offset-md-3">
                                    ...
                                    <a class="dropdown-item" href="#">
                                        ...
                                        <div class="notification__content">
                                            ...
                                            <p>Your website’s active users count increased by <span
                                                    class="text-success text-semibold">28%</span> in the last week.
                                                Great job!</p>
                                        </div>
                                    </a>
                                    <a class="dropdown-item" href="#">
                            ...
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle text-nowrap px-3" data-toggle="dropdown"
                                    ...
                                    <img class="user-avatar rounded-circle mr-2"
                                        src="{{ asset('../template_admin/images/avatars/0.jpg') }}"> <span
                                        class="d-none d-md-inline-block">Sierra Brooks</span>
                                </a>
                                <div class="dropdown-menu dropdown-menu-small">
                                    <a class="dropdown-item" href="user-profile-lite.html"><i
                                            class="material-icons">&#xE7FD;</i> Profile</a>
                                    <a class="dropdown-item" href="components-blog-posts.html"><i
                                            class="material-icons">vertical_split</i> Blog Posts</a>
                                    <a class="dropdown-item" href="add-new-post.html"><i
                                            class="material-icons">note_add</i> Add New Post</a>
                ...
                <footer class="main-footer d-flex p-2 px-3 bg-white border-top">
                    ...
                    <span class="copyright ml-auto my-auto mr-2">Copyright © 2018 <a href="https://designrevision.com"
    ...
    <script src="{{ asset('template_admin/scripts/app/app-blog-overview.1.1.0.min.js') }}"></script>
</body>
