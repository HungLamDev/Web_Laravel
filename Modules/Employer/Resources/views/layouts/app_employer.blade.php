    ...
    <div class="theme-layout" id="scrollup">
        <div class="responsive-header">
            <div class="responsive-menubar">
                <div class="res-logo"><a href="{{ route('get.home') }}" title=""><img
        ...
        <header class="stick-top">
            <div class="menu-sec">
                <div class="container">
                    <div class="logo">
                        <a href="{{ route('get.home') }}" title=""><img style="width:45px;height:40px"
                                src="https://iweb.tatthanh.com.vn/pic/3/blog/logo-cong-nghe.jpg" alt=""></a>
                    </div>
                    <!-- Logo -->
                    <div class="btns-profiles-sec">
                        <span><img style="width:45px;height:40px"
                                src="https://iweb.tatthanh.com.vn/pic/3/blog/logo-cong-nghe.jpg" alt="">
                            {{ Auth::guard('users')->user()->name }} <i class="la la-angle-down"></i></span>
                        <ul>
                            @foreach (config('user.drop_menu') as $item)
                                <li><a href="{{ route($item['route']) }}" title=""><i
                                            class="{{ $item['icon'] }}"></i>{{ $item['name'] }}</a></li>
                            @endforeach
                            <li><a href="" title=""><i class="la la-lock"></i>Đổi
                                    mật khẩu</a></li>
                        ...
                        <ul>
                            ...
                            <li class="menu-item-has-children">
                                ...
                                <ul>
                                    ...
                                    <li><a href="pricing.html" title="">Pricing Plans</a></li>
                                    <li><a href="register.html" title="">Register</a></li>
                                    <li><a href="terms_and_condition.html" title="">Terms &amp; Condition</a>
                                    </li>
                                </ul>
                            </li>
                        </ul>
